...
lm_dict = {
    ...
    "qwen2.5-7b": dspy.LM('hosted_vllm/Qwen/Qwen2.5-7B-Instruct', temperature=1.0, api_base=os.environ.get("BABEL_API_BASE")),
    "ministral-8b": dspy.LM('hosted_vllm/mistralai/Ministral-8B-Instruct-2410', temperature=1.0, api_base=os.environ.get("BABEL_API_BASE")),
    "llama3.1-8b": dspy.LM('hosted_vllm/meta-llama/Llama-3.1-8B-Instruct', temperature=1.0, api_base=os.environ.get("BABEL_API_BASE")),
}
